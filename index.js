...
function lineWrapper() {
  ...
  for (let i = 0; i < data.length; i++) {
    ...
    pattern.src = `./assests/${data[i].letter}.svg`
    data[i].letter.length === 2 ? pattern.className = 'letterU' : pattern.className = 'pattern' 
    data[i].letter === "ԵՎ" ? pattern.classList.add('letterEV') : '';
